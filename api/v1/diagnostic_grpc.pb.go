...
type DiagnosticClient interface {
	...
	SendNMI(ctx context.Context, in *SendNMIRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *diagnosticClient) SendNMI(ctx context.Context, in *SendNMIRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/github.com.tinkerbell.pbnj.api.v1.Diagnostic/SendNMI", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DiagnosticServer interface {
	...
	SendNMI(context.Context, *SendNMIRequest) (*empty.Empty, error)
...
func (UnimplementedDiagnosticServer) SendNMI(context.Context, *SendNMIRequest) (*empty.Empty, error) {
...
func _Diagnostic_SendNMI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.tinkerbell.pbnj.api.v1.Diagnostic/SendNMI",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
