...
var file_api_v1_diagnostic_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x32, 0x87, 0x01, 0x0a, 0x0a, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69,
	...
	0x73, 0x68, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x33, 0x5a, 0x21,
...
var file_api_v1_diagnostic_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_v1_diagnostic_proto_goTypes = []interface{}{
	...
	(*Authn)(nil),              // 2: github.com.tinkerbell.pbnj.api.v1.Authn
	(*Vendor)(nil),             // 3: github.com.tinkerbell.pbnj.api.v1.Vendor
}
var file_api_v1_diagnostic_proto_depIdxs = []int32{
	2, // 0: github.com.tinkerbell.pbnj.api.v1.ScreenshotRequest.authn:type_name -> github.com.tinkerbell.pbnj.api.v1.Authn
	3, // 1: github.com.tinkerbell.pbnj.api.v1.ScreenshotRequest.vendor:type_name -> github.com.tinkerbell.pbnj.api.v1.Vendor
	0, // 2: github.com.tinkerbell.pbnj.api.v1.Diagnostic.Screenshot:input_type -> github.com.tinkerbell.pbnj.api.v1.ScreenshotRequest
	1, // 3: github.com.tinkerbell.pbnj.api.v1.Diagnostic.Screenshot:output_type -> github.com.tinkerbell.pbnj.api.v1.ScreenshotResponse
